...
class VideoProcessor:
    ...
    def _build_export_command(
        self, source_file: str, clip: Clip, output_file: str, settings: Dict[str, Any]
    ) -> List[str]:
    ...
    async def generate_thumbnail(
        self, file_path: str, timestamp: float
    ) -> Optional[str]:
        ...
        try:
            thumbnail_file = (
                self.temp_dir / f"thumb_{timestamp}_{os.path.basename(file_path)}.jpg"
            )
